...
fit f(x) "<(sed -n '/^-0\.5/,/^0\.5/p' StressPerm.txt)" using ($2*10**9):($3/eps_free) via Q11

f(x)= eta0y*eps_free + 2*x*Q21
fit f(x) "<(sed -n '/^-0\.5/,/^0\.5/p' StressPerm.txt)" using ($2*10**9):($7/eps_free) via Q21

f(x)= eta0z*eps_free + 2*x*Q31
fit f(x) "<(sed -n '/^-0\.5/,/^0\.5/p' StressPerm.txt)" using ($2*10**9):($11/eps_free) via Q31

f(x)= eta0yz*eps_free + 2*x*Q41
fit f(x) "<(sed -n '/^-0\.5/,/^0\.5/p' StressPerm.txt)" using ($2*10**9):($8/eps_free) via Q41

f(x)= eta0xz*eps_free + 2*x*Q51
fit f(x) "<(sed -n '/^-0\.5/,/^0\.5/p' StressPerm.txt)" using ($2*10**9):($5/eps_free) via Q51

f(x)= eta0xy*eps_free + 2*x*Q61
fit f(x) "<(sed -n '/^-0\.5/,/^0\.5/p' StressPerm.txt)" using ($2*10**9):($4/eps_free) via Q61
