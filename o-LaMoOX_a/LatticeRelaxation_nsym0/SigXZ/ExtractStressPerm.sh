...
eps_e0x=$( grep -A3 'Electronic dielectric tensor'  SigXZ_0.0GPa/DFPT/anaddb.out | sed -n 2p | awk '{print $1}'  )
eps_e0y=$( grep -A3 'Electronic dielectric tensor'  SigXZ_0.0GPa/DFPT/anaddb.out | sed -n 3p | awk '{print $2}'  )
eps_e0z=$( grep -A3 'Electronic dielectric tensor'  SigXZ_0.0GPa/DFPT/anaddb.out | sed -n 4p | awk '{print $3}'  )
...
a0x=$(grep acell SigXZ_0.0GPa/abi.out | tail -n1 | awk '{printf "%-10.7f", $2*0.5292083}')
a0y=$(grep acell SigXZ_0.0GPa/abi.out | tail -n1 | awk '{printf "%-10.7f", $3*0.5292083}')
a0z=$(grep acell SigXZ_0.0GPa/abi.out | tail -n1 | awk '{printf "%-10.7f", $4*0.5292083}')
...
then
  energy=$(  grep '>>>>>>>>> Etotal='       SigXZ_${j}GPa/DFPT/abi.out | tail -n 1 | awk '{printf "%-20.14f\n", $3*27.2113834}')
  stress1=$( grep -A3 'stress tensor (GPa)' SigXZ_${j}GPa/DFPT/abi.out  | tail -n 3 | sed -n 1p | awk '{print $4}' )
  stress2=$( grep -A3 'stress tensor (GPa)' SigXZ_${j}GPa/DFPT/abi.out  | tail -n 3 | sed -n 2p | awk '{print $4}' )
  stress3=$( grep -A3 'stress tensor (GPa)' SigXZ_${j}GPa/DFPT/abi.out  | tail -n 3 | sed -n 3p | awk '{print $4}' )
  stress4=$( grep -A3 'stress tensor (GPa)' SigXZ_${j}GPa/DFPT/abi.out  | tail -n 3 | sed -n 1p | awk '{print $7}' )
  stress5=$( grep -A3 'stress tensor (GPa)' SigXZ_${j}GPa/DFPT/abi.out  | tail -n 3 | sed -n 2p | awk '{print $7}' )
  stress6=$( grep -A3 'stress tensor (GPa)' SigXZ_${j}GPa/DFPT/abi.out  | tail -n 3 | sed -n 3p | awk '{print $7}' )
  ...
  eps_ex=$( grep -A3 'Electronic dielectric tensor'  SigXZ_${j}GPa/DFPT/anaddb.out | sed -n 2p | awk '{print $1}'  )
  eps_ey=$( grep -A3 'Electronic dielectric tensor'  SigXZ_${j}GPa/DFPT/anaddb.out | sed -n 3p | awk '{print $2}'  )
  eps_ez=$( grep -A3 'Electronic dielectric tensor'  SigXZ_${j}GPa/DFPT/anaddb.out | sed -n 4p | awk '{print $3}'  )
 
 
  w_TA=$(  grep -A2 -i "Phonon frequencies in cm-1" SigXZ_${j}GPa/DFPT/anaddb.out | tail -n 3 | sed -n 2p | awk '{print $2}' )
  w_LA=$(  grep -A2 -i "Phonon frequencies in cm-1" SigXZ_${j}GPa/DFPT/anaddb.out | tail -n 3 | sed -n 2p | awk '{print $4}' )
  w_TO=$(  grep -A2 -i "Phonon frequencies in cm-1" SigXZ_${j}GPa/DFPT/anaddb.out | tail -n 3 | sed -n 2p | awk '{print $5}' )
  w_LO=$(  grep -A2 -i "Phonon frequencies in cm-1" SigXZ_${j}GPa/DFPT/anaddb.out | tail -n 3 | sed -n 3p | awk '{print $2}' )
